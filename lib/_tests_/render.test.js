...
<text x="50" y="125" font-size="60" text-anchor="middle" fill="${textColor}">${textContent}</text>
</svg>`)
...
<text x="50" y="115" font-size="60" text-anchor="middle" fill="${textColor}">${textContent}</text>
</svg>`)
...
<text x="100" y="150" font-size="60" text-anchor="middle" fill="${textColor}">${textContent}</text>
</svg>`)
